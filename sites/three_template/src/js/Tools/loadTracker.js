...
export function clampDevicePixelRatio(devicePixelRatio, max = 2) {
...
export function mountLoaderTemplate(template) {
  const host = document.getElementById("loader-root") || document.createElement("div")
  host.id = "loader-root"
  host.innerHTML = ""
  if (!host.parentNode) {
