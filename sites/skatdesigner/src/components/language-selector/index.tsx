    ...
    <div className="flex items-end">
      <Popover>
        <PopoverTrigger asChild>
          <button type="button" aria-label="Change language" className="flex items-center gap-1 fill-black text-black">
            <Languages size={18} />
          ...
          {localesAndNames.map(({ locale, name }) => {
            ...
            return (
              <button
                ...
                className={cn(`relative w-auto cursor-pointer select-none px-4 py-2 text-left text-black hover:bg-zinc-200`)}
              >
